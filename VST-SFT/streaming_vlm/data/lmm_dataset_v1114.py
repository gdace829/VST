...
class streamingDataset(LMMDataset):
    ...
    def preprocess_conversation_stream(self, conversation: list):
        ...
        clip_start_idx = 0
        clip_end_idx = 0
        while assistant_text_stream[i][1] < video_end:
            if assistant_text_stream[i][1] - assistant_text_stream[i][0] >= self.streaming_fps_frames:
                ...
                if len(qa_stream) > 0 and start_timestamp < qa_stream[0][1] and end_timestamp >= qa_stream[0][1]:
                    ...
                    question = ''
                    answer = ''
                clip_start_idx, clip_end_idx = i, i + self.streaming_fps_frames
            i += 1
